...
var genReplies = ["Pffft! They haven't made a good record in years, if ever.", "I don't pay attention to minor work.", "I don't think you know what music is.", "Broh, do you even listen to music?","Am I supposed to take you seriously?", "Yeah, I think NPR said they were cool.", "I don't listen to that because I only listen to music that no one else has heard of.", "I don't listen to commercial music.", "Sure, they have maybe one good album.", "No one would upvote that opinion.", "How pedestrian, tsk tsk..."]
var coolReplies = ["That is most excellent music! You are a being of impeccable taste.", "One of the greats.", "Yeah, you get it.", "Now I know that's right.", "That is most definitely where it's at.", "That's my jam!", "You're not the first person to tell me that. I need to listen to more.", "Me and my friends love that shit!"]
